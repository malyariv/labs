...
/**
 * The class {@code DBSynchronizedCacheList} is a wrapper for {@code DBCacheList}.
...
public class DBSynchronizedCacheList<T> implements List<T> {

    private final DBCacheList<T> list;

    public DBSynchronizedCacheList(DBCacheList<T> l){
        list=l;
    }
    @Override
