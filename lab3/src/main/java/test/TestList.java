...
public class TestList {
    ...
    private void run(){
        ...
        if (i==1) {
            myList=new DBSafeList<MyData>(folder,false);
        }
        else {
            myList=new DBSmartList<MyData>(folder,false);
        }
        mainMenu();
        label:
        while (true){
...
//        myList.clear();
    ...
    private void removeMenu(){
        ...
        int q=Integer.valueOf(scanner.nextLine());
        int i=0;
        Iterator<MyData> iterator=myList.iterator();
    ...
    private void compare(){
        ...
        List<MyData> trueList=new ArrayList<>(Arrays.asList(array));
